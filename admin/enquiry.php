            ...
            <div class="col-12">
              <div class="page_title_box d-flex align-items-center justify-content-between">
                <div class="page_title_left">
                  <h3 class="f_s_30 f_w_700 text_white">View Enquiry</h3>
                ...
                <a href="./export/export_enquiry.php"  class="white_btn3">Export</a>
              </div>
            </div>
          </div>
          <div class="row ">
