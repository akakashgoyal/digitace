            ...
            <div class="col-12">
              <div class="page_title_box d-flex align-items-center justify-content-between bg-custom">
                <div class="page_title_left">
                  <h3 class="f_s_30 f_w_700 text_white">Add Blog</h3>
                ...
                <a href="view-blog.php" class="white_btn3">View Blog</a>
              </div>
            </div>
          </div>
          <div class="row ">
                            ...
                            <div class="white_card_header">
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        <h3 class="m-0">Fill all the Blog details</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="white_card_body">
                                <div class="card-body">
                                    <form action="function.php" method="POST" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label class="form-label" for="inputEmail4">Blog Title</label>
                                                <input type="text" class="form-control" name="blog_title" id="categoryname"
                                                    placeholder="Blog Title">
                                            </div>  
                                            <div class="col-md-6 mb-3 ">
                                                <label class="form-label" for="inputEmail4">Author Name</label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="short_description"  id="categoryname"
                                            ...
                                            <div class="col-md-6 mb-3">
                                             ...
                                             <div class="col-md-6 mb-3">
                                                <label class="form-label" for="inputEmail4">Blog Image</label>
