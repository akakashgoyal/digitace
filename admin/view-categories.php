            ...
            <div class="col-12">
              <div class="page_title_box d-flex align-items-center justify-content-between">
                <div class="page_title_left">
                  <h3 class="f_s_30 f_w_700 text_white">View Services</h3>
                ...
                <a href="add-categories.php" class="white_btn3">Add New Services</a>
              </div>
            </div>
          </div>
          <div class="row ">
                            ...
                            <div class="white_card_header">
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        <h3 class="m-0">Services Table</h3>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="add_button ms-2">
                                                <a href="add-categories.php" data-bs-toggle="modal" data-bs-target="#addcategory"
                                                    class="btn_1">Add New Services</a>
                                            </div>
                                        </div>
                                    </div>
